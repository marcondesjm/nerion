...
const WHATSAPP_URL =
  "https://wa.me/5548996029392?text=Oi%2C%20quero%20acessar%20o%20Nerion%20OS.";

const systemSlides = [
  {
    title: "Contexto vivo",
    command: "nerion map --business",
    items: ["ICP definido", "Oferta organizada", "Tom de voz salvo"],
  },
  {
    title: "Conteudo em escala",
    command: "nerion create --carousel",
    items: ["Roteiro", "Copy", "Slides", "CTA"],
  },
  {
    title: "Operacao comercial",
    command: "nerion sales --proposal",
    items: ["Briefing", "Diagnostico", "Proposta", "Follow-up"],
  },
];

const socialProofs = [
  {
    title: "Mais clareza na oferta",
    description: "Diagnostico, promessa e publico ficam registrados em um unico contexto.",
  },
  {
    title: "Processos prontos para IA",
    description: "Cada rotina vira comando reutilizavel para a equipe executar com padrao.",
  },
  {
    title: "Conteudo gerado em minutos",
    description: "Posts, carrosseis e copies nascem com memoria de marca e objetivo claro.",
  },
  {
    title: "Propostas mais rapidas",
    description: "Briefing, escopo e valor comercial saem organizados para fechar negocio.",
  },
  {
    title: "Atendimento mais organizado",
    description: "Respostas seguem tom, historico e proximos passos sem perder informacao.",
  },
  {
    title: "Campanhas com contexto",
    description: "Anuncios e criativos partem da mesma estrategia, oferta e identidade.",
  },
];
  ...
  return (
    <main className="mazyos-clone" ref={pageRef}>
      ...
      <section className="hero-screen" id="hero">
        <div className="hero-content">
          <div className="hero-copy">
            ...
            <a className="outline-button" href={WHATSAPP_URL} rel="noreferrer" target="_blank">
              ACESSAR NERION OS
            </a>
          </div>
          <img
      ...
      <section className="lessons-screen" id="lessons">
        <h2>Nerion OS + sistema de implementação</h2>
        <p>Um painel operacional para organizar contexto, conteúdo, vendas e execução com IA.</p>
        <div className="system-carousel" aria-label="Carrossel de telas do sistema">
          {systemSlides.map((slide, index) => (
            <article
              className="system-slide"
              key={slide.title}
            ...
            >
              ...
              <div className="system-command">› {slide.command}</div>
      ...
      <section className="proof-section" aria-label="Provas sociais">
        <span>Provas sociais</span>
        <h2>Empresas ganham velocidade quando a IA entende o contexto.</h2>
        <div className="proof-marquee">
          <div className="proof-track">
            {[...socialProofs, ...socialProofs].map((proof, index) => (
              <article className="proof-card" key={`${proof.title}-${index}`}>
      ...
      <section className="pricing-screen" id="pricing">
        ...
        <div className="pricing-grid">
          <article className="price-panel">
            ...
            <hr />
            <a className="solid-button" href={WHATSAPP_URL} rel="noreferrer" target="_blank">
